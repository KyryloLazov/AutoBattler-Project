...
{
    public class UnitHealHandler : IStateHandle
    {
        private readonly InitializationUnitStateMachine _fsm;
        private readonly UnitFacade _facade;

        public UnitHealHandler(InitializationUnitStateMachine fsm, UnitFacade facade)
        {
            _fsm = fsm;
            _facade = facade;
        }
        ...
        public void Handle()
        {
            _fsm.StateMachine.SwitchStates<UnitHealState>();
        }
    }
}